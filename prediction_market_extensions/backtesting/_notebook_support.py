...
def display_html_artifacts(html_artifacts: Sequence[Path], *, repo_root: Path) -> None:
    ...
    display(Markdown(f"## Generated HTML Artifact\n\n`{relative_html}`"))
    display(HTML(primary_html.read_text(encoding="utf-8")))
