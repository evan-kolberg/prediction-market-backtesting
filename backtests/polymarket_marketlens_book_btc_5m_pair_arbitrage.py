...
# Added in this repository on 2026-08-17.
...
BTC_5M_WINDOW_START = datetime(2026, 8, 14, 12, 0, tzinfo=UTC)
...
def run() -> None:
    ...
    from prediction_market_extensions.backtesting.data_sources import Book, Marketlens, Polymarket
    ...
    def _run() -> None:
        run_experiment(
            build_replay_experiment(
                name="polymarket_marketlens_book_btc_5m_pair_arbitrage",
                description=(
                    "BTC 5m gross complementary-token entries using Marketlens L2 book data"
                ),
                ...
                empty_message="No Marketlens BTC 5m pair-arbitrage sims met the book requirements.",
