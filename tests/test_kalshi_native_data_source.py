...
def test_configured_kalshi_native_data_source_isolates_concurrent_loader_config() -> (
    None
):
    ...
    async def _run() -> tuple[str, str]:
        return await asyncio.gather(
            _capture("api-a.kalshi.test/trade-api/v2"),
            _capture("api-b.kalshi.test/trade-api/v2"),
        )
