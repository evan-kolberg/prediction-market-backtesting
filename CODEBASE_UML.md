...
Generated: 2026-05-03T03:22:38+00:00
...
- Imports: `__future__, collections, datetime, decimal, importlib, json, os, pathlib, types, typing, urllib`
- Function L30: `_env_enabled(name: str) -> bool | None`
- Function L42: `_extension_module() -> ModuleType | None`
- Function L68: `native_available() -> bool`
- Function L75: `_validate_semantics(semantics: str) -> WindowSemantics`
- Function L82: `_format_utc_day(day_index: int) -> str`
- Function L86: `_source_days_for_window_python(start_ns: int, end_ns: int, semantics: WindowSemantics) -> list[str]`
- Function L103: `_pmxt_archive_hours_for_window_python(start_ns: int, end_ns: int) -> list[int]`
- Function L112: `_decimal_seconds_to_ns_python(value: object) -> int`
- Function L116: `_float_seconds_to_ms_string_python(value: float) -> str`
- Function L120: `_pmxt_payload_sort_key_python(update_type: str, payload_text: str) -> tuple[int, int]`
- Function L132: `_pmxt_extract_payload_fields_python(payload_text: str) -> tuple[str, str, int, str, str, tuple[str, str, str] | None]`
- Function L160: `_polymarket_trade_sort_key_python(timestamp: int, transaction_hash: str, asset: str, side: str, price: str, size: str) -> tuple[int, str, str, str, str, str]`
- Function L171: `_polymarket_trade_id_python(transaction_hash: str, asset: str, sequence: int) -> str`
- Function L175: `_polymarket_normalize_trade_side_python(side: str) -> str`
- Function L182: `_polymarket_is_tradable_probability_price_python(price: str) -> bool`
- Function L190: `_polymarket_trade_event_timestamp_ns_python(base_timestamp_ns: int, occurrence_in_second: int) -> int`
- Function L197: `_telonex_source_label_kind_python(source: str) -> str | None`
- Function L209: `_telonex_stage_for_source_python(source: str) -> str`
- Function L213: `_telonex_api_url_python(base_url: str, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None) -> str`
- Function L232: `_telonex_outcome_segments(token_index: int, outcome: str | None) -> list[str]`
- Function L239: `_telonex_local_consolidated_candidate_paths_python(root: str, channel: str, market_slug: str, token_index: int, outcome: str | None) -> list[str]`
- Function L263: `_telonex_local_daily_candidate_paths_python(root: str, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None) -> list[str]`
- Function L296: `source_days_for_window_ns(start_ns: int, end_ns: int, *, semantics: str = 'inclusive') -> list[str]`
- Function L306: `telonex_source_days_for_window_ns(start_ns: int, end_ns: int) -> list[str]`
- Function L313: `telonex_day_window_ns(date: str, start_ns: int, end_ns: int) -> tuple[int, int] | None`
- Function L329: `telonex_flat_book_snapshot_diff_rows(*, timestamp_ns: Sequence[int], bid_prices: Sequence[Sequence[str]], bid_sizes: Sequence[Sequence[str]], ask_prices: Sequence[Sequence[str]], ask_sizes: Sequence[Sequence[str]], start_ns: int, end_ns: int) -> tuple[int | None, list[int], list[int], list[int], list[float], list[float], list[int], list[int], list[int], list[int]] | None`
- Function L390: `telonex_onchain_fill_trade_rows(*, timestamp_ns: Sequence[int], prices: Sequence[object], sizes: Sequence[object], sides: Sequence[object] | None, ids: Sequence[object] | None, start_ns: int, end_ns: int, token_suffix: str) -> tuple[list[float], list[float], list[int], list[str], list[int], list[int]] | None`
- Function L441: `pd_day_start_ns(date: str) -> int`
- Function L445: `decimal_seconds_to_ns(value: object) -> int`
- Function L456: `float_seconds_to_ms_string(value: float) -> str`
- Function L463: `pmxt_payload_sort_key(update_type: str, payload_text: str) -> tuple[int, int]`
- Function L471: `pmxt_payload_sort_keys(items: Sequence[tuple[str, str]]) -> list[tuple[int, int]]`
- Function L484: `pmxt_sort_payloads(items: Sequence[tuple[str, str]]) -> list[tuple[int, int, str, str]]`
- Function L509: `pmxt_sort_payload_columns(update_type_columns: Sequence[Sequence[str]], payload_text_columns: Sequence[Sequence[str]]) -> list[tuple[int, int, str, str]]`
- Function L544: `pmxt_payload_delta_rows(*, update_type_columns: Sequence[Sequence[str]], payload_text_columns: Sequence[Sequence[str]], token_id: str, start_ns: int, end_ns: int, has_snapshot: bool, last_payload_key: tuple[int, int] | None) -> tuple[bool, tuple[int, int] | None, dict[str, list[object]]] | None`
- Function L609: `pmxt_extract_payload_fields(payload_text: str) -> tuple[str, str, int, str, str, tuple[str, str, str] | None]`
- Function L630: `polymarket_trade_sort_key(trade: Mapping[str, object]) -> tuple[int, str, str, str, str, str]`
- Function L652: `polymarket_trade_sort_keys(trades: Sequence[Mapping[str, object]]) -> list[tuple[int, str, str, str, str, str]]`
- Function L684: `polymarket_trade_id(transaction_hash: str, asset: str, sequence: int) -> str`
- Function L691: `polymarket_trade_ids(rows: Sequence[tuple[str, str, int]]) -> list[str]`
- Function L701: `polymarket_normalize_trade_side(side: str) -> str`
- Function L708: `polymarket_normalize_trade_sides(sides: Sequence[str]) -> list[str]`
- Function L715: `polymarket_is_tradable_probability_price(price: str) -> bool`
- Function L722: `polymarket_are_tradable_probability_prices(prices: Sequence[str]) -> list[bool]`
- Function L731: `polymarket_trade_event_timestamp_ns(base_timestamp_ns: int, occurrence_in_second: int) -> int`
- Function L743: `polymarket_trade_event_timestamp_ns_batch(rows: Sequence[tuple[int, int]]) -> list[int]`
- Function L757: `replay_merge_plan(*, book_ts_events: Sequence[int], book_ts_inits: Sequence[int], trade_ts_events: Sequence[int], trade_ts_inits: Sequence[int]) -> list[tuple[int, int]] | None`
- Function L778: `pmxt_archive_hours_for_window_ns(start_ns: int, end_ns: int) -> list[int]`
- Function L785: `telonex_source_label_kind(source: str) -> str | None`
- Function L793: `telonex_stage_for_source(source: str) -> str`
- Function L800: `telonex_api_url(*, base_url: str, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None) -> str`
- Function L817: `_telonex_outcome_cache_segment(token_index: int, outcome: str | None) -> str`
- Function L823: `quote_path_component(value: str) -> str`
- Function L827: `telonex_api_cache_relative_path(*, base_url_key: str, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None) -> Path`
- Function L856: `telonex_deltas_cache_relative_path(*, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None, instrument_key: str, start_ns: int, end_ns: int) -> Path`
- Function L894: `telonex_trade_ticks_cache_relative_path(*, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None, instrument_key: str, start_ns: int, end_ns: int) -> Path`
- Function L932: `telonex_local_consolidated_candidate_paths(*, root: Path, channel: str, market_slug: str, token_index: int, outcome: str | None) -> tuple[Path, ...]`
- Function L956: `telonex_local_daily_candidate_paths(*, root: Path, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None) -> tuple[Path, ...]`
...
- Function L23: `format_utc_timestamp_ns(epoch_ns: int) -> str`
- Function L29: `_normalize_level(level: str) -> str`
- Function L36: `_caller_origin(*, stacklevel: int) -> str`
- Function L50: `_json_safe(value) -> Any`
- Function L145: `_is_standard_stream(stream: TextIO) -> bool`
- Function L149: `_tqdm_write_line(line: str, *, stream: TextIO) -> bool`
- Function L160: `_write_console_line(line: str, *, stream: TextIO) -> None`
- Function L205: `loader_event_sinks_from_env(environ: Mapping[str, str] | None = None, *, include_console: bool = True) -> tuple[LoaderEventSink, ...]`
- Function L221: `format_log_line(message: object, *, level: str, origin: str, timestamp_ns: int) -> str`
- Function L233: `get_loader_event_sinks() -> tuple[LoaderEventSink, ...]`
- Function L238: `set_loader_event_sinks(sinks: Sequence[LoaderEventSink]) -> None`
- Function L244: `register_loader_event_sink(sink: LoaderEventSink) -> None`
- Function L249: `configure_loader_event_sinks_from_env(environ: Mapping[str, str] | None = None) -> None`
- Function L254: `loader_event_sinks(sinks: Sequence[LoaderEventSink]) -> Iterator[None]`
- Function L264: `capture_loader_events() -> Iterator[CaptureEventSink]`
- Function L270: `_emit_event(event: LoaderEvent, *, sinks: Sequence[LoaderEventSink] | None = None) -> None`
- Function L277: `emit_loader_event(message: object, *, level: LogLevel = 'INFO', stage: str = 'runtime', vendor: str = 'repo', status: str = 'complete', origin: str | None = None, clock_ns: Callable[[], int] = time.time_ns, stacklevel: int = 2, sinks: Sequence[LoaderEventSink] | None = None, **fields) -> None`
- Function L341: `log_message(message: object, *, level: LogLevel = 'INFO', origin: str | None = None, stream: TextIO | None = None, clock_ns: Callable[[], int] = time.time_ns, stacklevel: int = 2) -> None`
- Function L361: `log_debug(message: object, *, origin: str | None = None, stacklevel: int = 2) -> None`
- Function L365: `log_info(message: object, *, origin: str | None = None, stacklevel: int = 2) -> None`
- Function L369: `log_warning(message: object, *, origin: str | None = None, stacklevel: int = 2) -> None`
- Function L373: `log_error(message: object, *, origin: str | None = None, stacklevel: int = 2) -> None`
- Function L377: `clone_event(event: LoaderEvent, **changes) -> LoaderEvent`
- Class L65: `LoaderEvent`
  - Method L93: `__post_init__(self) -> None`
  - Method L102: `to_dict(self) -> dict[str, Any]`
- Class L141: `LoaderEventSink(Protocol)`
  - Method L142: `emit(self, event: LoaderEvent) -> None`
- Class L167: `ConsoleEventSink`
  - Method L170: `emit(self, event: LoaderEvent) -> None`
- Class L184: `JsonlEventSink`
  - Method L187: `emit(self, event: LoaderEvent) -> None`
- Class L195: `CaptureEventSink`
  - Method L198: `emit(self, event: LoaderEvent) -> None`
...
- Function L56: `_trade_sort_key(trade: dict[str, Any]) -> tuple[int, str, str, str, str, str]`
- Function L60: `_sort_trades_in_place(trades: list[dict[str, Any]]) -> None`
- Class L70: `PolymarketDataLoader`
  - Method L98: `__init__(self, instrument: BinaryOption, token_id: str | None = None, condition_id: str | None = None, http_client: nautilus_pyo3.HttpClient | None = None, resolution_metadata: dict[str, Any] | None = None) -> None`
  - Method L113: `resolution_metadata(self) -> dict[str, Any]`
  - Method L123: `_create_http_client() -> nautilus_pyo3.HttpClient`
  - Method L129: `async _fetch_market_by_slug(slug: str, http_client: nautilus_pyo3.HttpClient) -> dict[str, Any]`
  - Method L183: `async _fetch_market_details(condition_id: str, http_client: nautilus_pyo3.HttpClient) -> dict[str, Any]`
  - Method L231: `_coerce_fee_rate_bps(value) -> Decimal | None`
  - Method L241: `async _fetch_market_fee_rate_bps(cls, token_id: str, http_client: nautilus_pyo3.HttpClient) -> Decimal | None`
  - Method L283: `async _enrich_market_details_with_fee_rate(cls, market_details: dict[str, Any], token_id: str, http_client: nautilus_pyo3.HttpClient) -> dict[str, Any]`
  - Method L303: `async _fetch_event_by_slug(slug: str, http_client: nautilus_pyo3.HttpClient) -> dict[str, Any]`
  - Method L328: `async from_market_slug(cls, slug: str, token_index: int = 0, http_client: nautilus_pyo3.HttpClient | None = None) -> PolymarketDataLoader`
  - Method L412: `async from_event_slug(cls, slug: str, token_index: int = 0, http_client: nautilus_pyo3.HttpClient | None = None) -> list[PolymarketDataLoader]`
  - Method L493: `async query_market_by_slug(slug: str, http_client: nautilus_pyo3.HttpClient | None = None) -> dict[str, Any]`
  - Method L523: `async query_market_details(condition_id: str, http_client: nautilus_pyo3.HttpClient | None = None) -> dict[str, Any]`
  - Method L551: `async query_event_by_slug(slug: str, http_client: nautilus_pyo3.HttpClient | None = None) -> dict[str, Any]`
  - Method L581: `instrument(self) -> BinaryOption`
  - Method L588: `token_id(self) -> str | None`
  - Method L595: `condition_id(self) -> str | None`
  - Method L601: `async load_trades(self, start: pd.Timestamp | None = None, end: pd.Timestamp | None = None) -> list[TradeTick]`
  - Method L660: `async fetch_event_by_slug(self, slug: str) -> dict[str, Any]`
  - Method L687: `async fetch_events(self, active: bool = True, closed: bool = False, archived: bool = False, limit: int = 100, offset: int = 0) -> list[dict[str, Any]]`
  - Method L735: `async get_event_markets(self, slug: str) -> list[dict[str, Any]]`
  - Method L760: `async fetch_markets(self, active: bool = True, closed: bool = False, archived: bool = False, limit: int = 100, offset: int = 0) -> list[dict]`
  - Method L808: `async fetch_market_by_slug(self, slug: str) -> dict[str, Any]`
  - Method L832: `async find_market_by_slug(self, slug: str) -> dict[str, Any]`
  - Method L854: `async fetch_market_details(self, condition_id: str) -> dict[str, Any]`
  - Method L871: `async fetch_trades(self, condition_id: str, limit: int = _TRADES_PAGE_LIMIT, start_ts: int | None = None, end_ts: int | None = None) -> list[dict[str, Any]]`
  - Method L999: `parse_trades(self, trades_data: list[dict]) -> list[TradeTick]`
...
- Imports: `__future__, collections, concurrent, contextlib, datetime, msgspec, nautilus_trader, numpy, os, pandas, pathlib, prediction_market_extensions, pyarrow, re, shutil, tempfile, time, typing, urllib, warnings`
- Function L83: `_raw_fixed_values(values: list[object], precision: int) -> list[int]`
- Class L53: `_PMXTBookSnapshotPayload(msgspec.Struct)`
- Class L65: `_PMXTPriceChangePayload(msgspec.Struct)`
- Class L88: `PolymarketPMXTDataLoader(PolymarketDataLoader)`
  - Method L110: `__init__(self, *args, **kwargs) -> None`
  - Method L131: `last_load_gap_hours(self) -> tuple[pd.Timestamp, ...]`
  - Method L136: `_normalize_timestamp(value: pd.Timestamp | str | None) -> pd.Timestamp | None`
  - Method L145: `_archive_hours(start: pd.Timestamp, end: pd.Timestamp) -> list[pd.Timestamp]`
  - Method L160: `_archive_filename_for_hour(cls, hour: pd.Timestamp) -> str`
  - Method L165: `_archive_url_for_hour(cls, hour: pd.Timestamp) -> str`
  - Method L169: `_archive_relative_path_for_hour(cls, hour: pd.Timestamp) -> str`
  - Method L177: `_env_flag_enabled(value: str | None) -> bool`
  - Method L183: `_default_cache_dir(cls) -> Path`
  - Method L189: `_resolve_cache_dir(cls) -> Path | None`
  - Method L205: `_resolve_local_archive_dir(cls) -> Path | None`
  - Method L216: `_resolve_prefetch_workers(cls) -> int`
  - Method L231: `_market_cache_path_for_hour(cls, cache_dir: Path, condition_id: str, token_id: str, hour: pd.Timestamp) -> Path`
  - Method L236: `_cache_path_for_hour(self, hour: pd.Timestamp) -> Path | None`
  - Method L245: `_local_archive_candidate_paths_for_hour(cls, archive_dir: Path, hour: pd.Timestamp) -> tuple[Path, ...]`
  - Method L252: `_local_archive_paths_for_hour(self, hour: pd.Timestamp) -> tuple[Path, ...]`
  - Method L257: `_market_filter(self) -> Any`
  - Method L264: `_empty_market_table(cls) -> pa.Table`
  - Method L270: `_to_market_batch(cls, batch: pa.RecordBatch) -> pa.RecordBatch`
  - Method L277: `_filter_batch_to_token(self, batch: pa.RecordBatch) -> pa.RecordBatch`
  - Method L287: `_filter_raw_batch(self, batch: pa.RecordBatch) -> pa.RecordBatch`
  - Method L304: `_load_cached_market_table(self, hour: pd.Timestamp) -> pa.Table | None`
  - Method L316: `_load_cached_market_batches(self, hour: pd.Timestamp) -> list[pa.RecordBatch] | None`
  - Method L329: `_write_market_cache(self, hour: pd.Timestamp, table: pa.Table) -> None`
  - Method L342: `_scan_raw_market_batches(self, dataset: ds.Dataset, *, batch_size: int, source: str | None = None, total_bytes: int | None = None) -> list[pa.RecordBatch]`
  - Method L397: `_load_remote_market_table(self, hour: pd.Timestamp, *, batch_size: int) -> pa.Table | None`
  - Method L405: `_load_remote_market_batches(self, hour: pd.Timestamp, *, batch_size: int) -> list[pa.RecordBatch] | None`
  - Method L411: `_load_raw_market_batches_via_download(self, archive_url: str, *, batch_size: int) -> list[pa.RecordBatch] | None`
  - Method L434: `_load_local_archive_market_batches(self, hour: pd.Timestamp, *, batch_size: int) -> list[pa.RecordBatch] | None`
  - Method L458: `_filter_table_to_token(self, table: pa.Table) -> pa.Table`
  - Method L468: `_load_market_table(self, hour: pd.Timestamp, *, batch_size: int) -> pa.Table | None`
  - Method L495: `_load_market_batches(self, hour: pd.Timestamp, *, batch_size: int) -> list[pa.RecordBatch] | None`
  - Method L520: `_emit_download_progress(self, url: str, *, downloaded_bytes: int, total_bytes: int | None, finished: bool) -> None`
  - Method L528: `_emit_scan_progress(self, source: str, *, scanned_batches: int, scanned_rows: int, matched_rows: int, total_bytes: int | None, finished: bool) -> None`
  - Method L544: `_content_length_from_response(response: object) -> int | None`
  - Method L556: `_progress_total_bytes(self, source: str) -> int | None`
  - Method L583: `_download_to_file_with_progress(self, url: str, destination: Path) -> int | None`
  - Method L632: `_download_payload_with_progress(self, url: str) -> bytes | None`
  - Method L671: `_load_raw_market_batches_from_local_file(self, parquet_path: Path, *, batch_size: int, progress_source: str, total_bytes: int | None) -> list[pa.RecordBatch] | None`
  - Method L683: `_temporary_download_filename(url: str) -> str`
  - Method L688: `_pid_is_active(pid: int) -> bool`
  - Method L700: `_temporary_download_path(self, url: str) -> Iterator[Path]`
  - Method L712: `_cleanup_stale_temp_downloads(self) -> None`
  - Method L741: `_iter_market_tables(self, hours: list[pd.Timestamp], *, batch_size: int) -> Iterator[tuple[pd.Timestamp, pa.Table | None]]`
  - Method L772: `_iter_market_batches(self, hours: list[pd.Timestamp], *, batch_size: int) -> Iterator[tuple[pd.Timestamp, list[pa.RecordBatch] | None]]`
  - Method L804: `_timestamp_to_ms_string(timestamp_secs: float) -> str`
  - Method L808: `_decode_book_snapshot(payload_text: str) -> _PMXTBookSnapshotPayload`
  - Method L812: `_decode_price_change(payload_text: str) -> _PMXTPriceChangePayload`
  - Method L816: `_to_book_snapshot(payload: _PMXTBookSnapshotPayload) -> PolymarketBookSnapshot`
  - Method L835: `_to_price_change(payload: _PMXTPriceChangePayload) -> PolymarketQuotes`
  - Method L857: `_event_sort_key(record: OrderBookDeltas) -> tuple[int, int]`
  - Method L862: `_deltas_records_from_columns(self, data: dict[str, list[object]]) -> list[OrderBookDeltas]`
  - Method L911: `_payload_sort_key(self, update_type: str, payload_text: str) -> tuple[int, int]`
  - Method L914: `_process_book_snapshot(self, payload_text: str, *, token_id: str, instrument, local_book: OrderBook, has_snapshot: bool, events: list[OrderBookDeltas], start_ns: int, end_ns: int, include_order_book: bool) -> tuple[OrderBook, bool]`
  - Method L950: `_process_price_change(self, payload_text: str, *, token_id: str, instrument, local_book: OrderBook, has_snapshot: bool, events: list[OrderBookDeltas], start_ns: int, end_ns: int, include_order_book: bool) -> OrderBook`
  - Method L985: `load_order_book_deltas(self, start: pd.Timestamp, end: pd.Timestamp, *, batch_size: int = 25000, include_order_book: bool = True) -> list[OrderBookDeltas]`
  - Method L1106: `_timestamp_to_ns(value: object) -> int`
...
- Function L74: `_record_ts_event(record) -> int | None`
- Function L84: `_largest_record_gap_ns(records: Sequence[Any]) -> int | None`
- Function L98: `_emit_engine_status(engine: BacktestEngine, message: str) -> None`
- Function L110: `_serialize_engine_result_stats(engine_result) -> dict[str, Any]`
- Function L514: `_LoadedMarketSim(*, spec: ReplaySpec, instrument, records: Sequence[Any], count: int, count_key: str, market_key: str, market_id: str, outcome: str, realized_outcome: float | None, prices: Sequence[float], metadata: Mapping[str, Any] | None, requested_start_ns: int | None, requested_end_ns: int | None) -> LoadedReplay`
- Class L122: `PredictionMarketBacktest`
  - Method L123: `__init__(self, *, name: str, data: MarketDataConfig, replays: Sequence[ReplaySpec], strategy_configs: Sequence[StrategyConfigSpec] = (), strategy_factory: StrategyFactory | None = None, initial_cash: float, probability_window: int, min_book_events: int = 0, min_price_range: float = 0.0, default_lookback_days: int | None = None, default_lookback_hours: float | None = None, default_start_time: pd.Timestamp | datetime | str | None = None, default_end_time: pd.Timestamp | datetime | str | None = None, nautilus_log_level: str = 'INFO', execution: ExecutionModelConfig | None = None, chart_resample_rule: str | None = None, return_summary_series: bool = False) -> None`
  - Method L171: `_strategy_summary_label(self) -> str`
  - Method L178: `run(self) -> list[dict[str, Any]]`
  - Method L188: `run_backtest(self) -> list[dict[str, Any]]`
  - Method L191: `async run_async(self) -> list[dict[str, Any]]`
  - Method L264: `async run_backtest_async(self) -> list[dict[str, Any]]`
  - Method L267: `_create_artifact_builder(self) -> PredictionMarketArtifactBuilder`
  - Method L279: `_build_result(self, *, loaded_sim: LoadedReplay, fills_report: pd.DataFrame, positions_report: pd.DataFrame, market_artifacts: Mapping[str, Any] | None = None, joint_portfolio_artifacts: Mapping[str, Any] | None = None, run_state: dict[str, Any] | None = None) -> dict[str, Any]`
  - Method L298: `_build_market_artifacts(self, *, engine: BacktestEngine, loaded_sims: Sequence[LoadedReplay], fills_report: pd.DataFrame) -> dict[str, dict[str, Any]]`
  - Method L309: `_build_joint_portfolio_artifacts(self, *, engine: BacktestEngine, loaded_sims: Sequence[LoadedReplay]) -> dict[str, Any]`
  - Method L316: `_normalize_replays(self, replays: Sequence[ReplaySpec]) -> tuple[ReplaySpec, ...]`
  - Method L329: `_load_request(self) -> ReplayLoadRequest`
  - Method L339: `async _load_sims_async(self) -> list[LoadedReplay]`
  - Method L363: `_build_engine(self) -> BacktestEngine`
  - Method L398: `_build_importable_strategy_configs(self, loaded_sims: Sequence[LoadedReplay]) -> list[Any]`
  - Method L420: `_is_batch_strategy_config(self, strategy_spec: StrategyConfigSpec) -> bool`
  - Method L429: `_contains_value(self, value, target: str) -> bool`
  - Method L438: `_bind_strategy_spec(self, *, strategy_spec: StrategyConfigSpec, loaded_sim: LoadedReplay, all_instrument_ids: Sequence[InstrumentId]) -> StrategyConfigSpec`
  - Method L466: `_bind_value(self, value, *, instrument_id: InstrumentId, all_instrument_ids: Sequence[InstrumentId], metadata: Mapping[str, Any]) -> Any`
...
- Function L813: `_normalize_mode(value: str | None) -> str`
- Function L827: `_env_value(name: str) -> str | None`
- Function L835: `_env_enabled(name: str) -> bool`
- Function L842: `_resolve_prefetch_workers_override(*, default_when_unset: int | None) -> int | None`
- Function L852: `_resolve_source_priority_override() -> tuple[str, ...]`
- Function L872: `_resolve_existing_remote_url() -> str | None`
- Function L877: `_resolve_existing_remote_urls() -> tuple[str, ...]`
- Function L893: `_resolve_required_directory(env_name: str, *, label: str) -> Path`
- Function L906: `_strip_prefixed_local_source(source: str, *, prefixes: Sequence[str]) -> str | None`
- Function L916: `_strip_prefixed_remote_source(source: str, *, prefixes: Sequence[str]) -> str | None`
- Function L926: `_classify_explicit_pmxt_sources(sources: Sequence[str]) -> tuple[str | None, tuple[str, ...], tuple[str, ...], tuple[str, ...], tuple[tuple[str, str], ...]]`
- Function L1002: `_explicit_source_summary(*, ordered_sources: Sequence[str], ordered_entries: Sequence[tuple[str, str]] = ()) -> str`
- Function L1020: `resolve_pmxt_loader_config(*, sources: Sequence[str] | None = None) -> tuple[PMXTDataSourceSelection, PMXTLoaderConfig]`
- Function L1158: `_loader_config_to_env_updates(config: PMXTLoaderConfig) -> dict[str, str | None]`
- Function L1172: `resolve_pmxt_data_source_selection(*, sources: Sequence[str] | None = None) -> tuple[PMXTDataSourceSelection, dict[str, str | None]]`
- Function L1182: `configured_pmxt_data_source(*, sources: Sequence[str] | None = None) -> Iterator[PMXTDataSourceSelection]`
...
- Class L85: `RunnerPolymarketPMXTDataLoader(PolymarketPMXTDataLoader)`
  ...
  - Method L122: `_emit_pmxt_source_event(self, *, message: str, stage: str, status: str, hour, source_kind: str | None = None, source: str | None = None, cache_path: Path | None = None, rows: int | None = None, bytes_count: int | None = None, level: str = 'INFO') -> None`
  - Method L156: `_source_kind_for_stage(stage: str) -> str`
  - Method L160: `_source_label_for_stage(stage: str, target: str | None) -> str | None`
  - Method L170: `_resolve_raw_root(cls) -> Path | None`
  - Method L186: `_resolve_remote_base_url(cls) -> str | None`
  - Method L191: `_resolve_remote_base_urls(cls) -> tuple[str, ...]`
  - Method L211: `_archive_url_for_hour(self, hour) -> Any`
  - Method L222: `_archive_urls_for_hour(self, hour) -> Any`
  - Method L230: `_raw_path_for_hour(self, hour) -> Path | None`
  - Method L243: `_raw_paths_for_hour_at_root(self, raw_root: Path, hour) -> tuple[Path, ...]`
  - Method L246: `_load_local_raw_market_batches_from_root(self, raw_root: Path, hour, *, batch_size: int) -> Any`
  ...
  - Method L445: `_load_market_table(self, hour, *, batch_size: int) -> Any`
  - Method L503: `_load_market_batches(self, hour, *, batch_size: int) -> Any`
  - Method L683: `_download_to_file_with_progress(self, url: str, destination: Path) -> int | None`
  - Method L736: `_download_payload_with_progress(self, url: str) -> bytes | None`
  - Method L776: `_progress_total_bytes(self, source: str) -> int | None`
- Class L808: `PMXTDataSourceSelection`
...
- Imports: `__future__, collections, contextlib, dataclasses, datetime, importlib, nautilus_trader, numpy, os, pandas, pathlib, prediction_market_extensions, time, typing, warnings`
- Function L54: `_resolve_backtest_compat_symbol(name: str, default) -> Any`
- Function L64: `_loader_realized_outcome(loader) -> float | None`
- Function L72: `_normalize_timestamp(value: object | None, *, default_now: bool = False) -> pd.Timestamp`
- Function L88: `_loaded_window(records: tuple[object, ...]) -> ReplayWindow | None`
- Function L104: `_requested_window(start: pd.Timestamp, end: pd.Timestamp) -> ReplayWindow`
- Function L108: `_price_range(prices: tuple[float, ...]) -> float`
- Function L114: `_best_book_midpoint(book: OrderBook) -> float | None`
- Function L122: `_book_event_count_and_midpoints(*, instrument, records: tuple[object, ...], deltas_type: type[Any]) -> tuple[int, tuple[float, ...]]`
- Function L139: `_validate_replay_window(*, market_label: str, count_label: str, count: int, min_record_count: int, prices: tuple[float, ...], min_price_range: float) -> bool`
- Function L168: `_cache_home() -> Path`
- Function L173: `_trade_cache_path(*, loader, date: pd.Timestamp) -> Path | None`
- Function L188: `_trade_record_sort_key(record: TradeTick) -> tuple[int, int]`
- Function L192: `_serialize_trade_ticks(trades: tuple[TradeTick, ...]) -> pd.DataFrame`
- Function L207: `_trade_ticks_from_native_columns(*, loader, data: tuple[list[float], list[float], list[int], list[str], list[int], list[int]]) -> tuple[TradeTick, ...]`
- Function L229: `_trade_ticks_from_cache_frame_native(*, loader, frame: pd.DataFrame) -> tuple[TradeTick, ...]`
- Function L266: `_rounded_float64_array(values, precision: int) -> np.ndarray`
- Function L270: `_deserialize_trade_ticks(*, loader, frame: pd.DataFrame) -> tuple[TradeTick, ...]`
- Function L276: `_write_trade_cache(*, path: Path, trades: tuple[TradeTick, ...]) -> None`
- Function L284: `_trade_day_label(day: pd.Timestamp) -> str`
- Function L288: `_print_trade_progress_header(*, market_label: str, start: pd.Timestamp, end: pd.Timestamp) -> None`
- Function L305: `_trade_source_label(source: str) -> str`
- Function L328: `_print_trade_progress_line(*, day: pd.Timestamp, elapsed_secs: float, rows: int, source: str) -> None`
- Function L351: `_polymarket_ceiling_warning(caught_warnings: list[warnings.WarningMessage]) -> str | None`
- Function L359: `_trade_days_for_window(start: pd.Timestamp, end: pd.Timestamp) -> tuple[pd.Timestamp, ...]`
- Function L372: `async _load_trade_ticks(loader, *, start: pd.Timestamp, end: pd.Timestamp, market_label: str) -> tuple[TradeTick, ...]`
- Function L444: `_record_sort_key(record: object) -> tuple[int, int, int]`
- Function L451: `_merge_records(*, book_records: tuple[OrderBookDeltas, ...], trade_records: tuple[TradeTick, ...]) -> tuple[object, ...]`
- Class L483: `_BaseReplayAdapter(HistoricalReplayAdapter)`
  - Method L493: `key(self) -> ReplayAdapterKey`
  - Method L497: `replay_spec_type(self) -> type[Any]`
  - Method L500: `configure_sources(self, *, sources: tuple[str, ...] | list[str]) -> AbstractContextManager[Any]`
  - Method L506: `engine_profile(self) -> ReplayEngineProfile`
  - Method L509: `build_single_market_replay(self, *, field_values: Mapping[str, Any]) -> Any`
  - Method L521: `_build_loaded_replay(self, *, replay, instrument, records: tuple[Any, ...], count: int, count_key: str, market_key: str, market_id: str, prices: tuple[float, ...], outcome: str, realized_outcome: float | None, metadata: dict[str, Any], requested_window: ReplayWindow) -> LoadedReplay`
- Class L557: `PolymarketPMXTBookReplayAdapter(_BaseReplayAdapter)`
  - Method L558: `__init__(self) -> None`
  - Method L585: `async load_replay(self, replay: BookReplay, *, request: ReplayLoadRequest) -> LoadedReplay | None`
- Class L695: `PolymarketTelonexBookReplayAdapter(_BaseReplayAdapter)`
  - Method L696: `__init__(self) -> None`
  - Method L726: `async load_replay(self, replay: BookReplay, *, request: ReplayLoadRequest) -> LoadedReplay | None`
...
- Function L114: `_raw_fixed_values(values: Sequence[object], precision: int) -> list[int]`
- Function L150: `_current_loader_config() -> TelonexLoaderConfig | None`
- Function L154: `_env_value(name: str) -> str | None`
- Function L164: `_resolve_channel(channel: str | None = None) -> str`
- Function L168: `_default_cache_root() -> Path`
- Function L174: `_resolve_api_cache_root() -> Path | None`
- Function L184: `_normalize_api_base_url(value: str | None) -> str`
- Function L193: `_expand_source_vars(source: str) -> str`
- Function L203: `_classify_telonex_sources(sources: Sequence[str]) -> tuple[TelonexSourceEntry, ...]`
- Function L246: `_default_telonex_sources_from_env() -> tuple[TelonexSourceEntry, ...]`
- Function L267: `_source_summary_parts(entries: Sequence[TelonexSourceEntry]) -> list[str]`
- Function L278: `_source_summary_line(label: str, parts: Sequence[str]) -> str`
- Function L282: `_trade_source_summary_parts(entries: Sequence[TelonexSourceEntry]) -> list[str]`
- Function L297: `_source_summary(entries: Sequence[TelonexSourceEntry]) -> str`
- Function L308: `resolve_telonex_loader_config(*, sources: Sequence[str] | None = None, channel: str | None = None) -> tuple[TelonexDataSourceSelection, TelonexLoaderConfig]`
- Function L328: `resolve_telonex_data_source_selection(*, sources: Sequence[str] | None = None) -> tuple[TelonexDataSourceSelection, dict[str, str | None]]`
- Function L336: `configured_telonex_data_source(*, sources: Sequence[str] | None = None, channel: str | None = None) -> Iterator[TelonexDataSourceSelection]`
- Class L120: `TelonexSourceEntry`
- Class L127: `TelonexLoaderConfig`
- Class L133: `TelonexDataSourceSelection`
- Class L139: `_TelonexDayResult`
- Class L347: `RunnerPolymarketTelonexBookDataLoader(PolymarketDataLoader)`
  - Method L348: `__init__(self, *args, **kwargs) -> None`
  - Method L353: `_ensure_blob_scan_caches(self) -> None`
  - Method L380: `async from_market_slug(cls, slug: str, token_index: int = 0, http_client = None) -> 'RunnerPolymarketTelonexBookDataLoader'`
  - Method L393: `_download_progress(self, url: str, downloaded_bytes: int, total_bytes: int | None, finished: bool) -> None`
  - Method L401: `_telonex_source_kind(source: str) -> str | None`
  - Method L405: `_telonex_stage_for_source(source: str) -> str`
  - Method L408: `_day_progress(self, date: str, event: str, source: str, rows: int) -> None`
  - Method L438: `_resolve_api_cache_root(cls) -> Path | None`
  - Method L442: `_resolve_prefetch_workers(cls) -> int`
  - Method L451: `_config(self) -> TelonexLoaderConfig`
  - Method L458: `_date_range(start: pd.Timestamp, end: pd.Timestamp) -> list[str]`
  - Method L464: `_outcome_segments(*, token_index: int, outcome: str | None) -> tuple[str, ...]`
  - Method L471: `_local_blob_root(root: Path) -> Path | None`
  - Method L485: `_outcome_segment_candidates(*, token_index: int, outcome: str | None) -> tuple[str, ...]`
  - Method L492: `_month_partition_dirs(*, channel_dir: Path, start: pd.Timestamp, end: pd.Timestamp) -> tuple[Path, ...]`
  - Method L503: `_readable_blob_part_paths(self, *, channel_dir: Path, start: pd.Timestamp, end: pd.Timestamp) -> tuple[list[str], bool]`
  - Method L540: `_scan_readable_blob_part_paths(self, partition_dir: Path) -> tuple[tuple[str, ...], bool]`
  - Method L573: `_manifest_blob_part_paths(self, *, store_root: Path, channel: str, market_slug: str, token_index: int, outcome: str | None, start: pd.Timestamp, end: pd.Timestamp) -> tuple[list[str], bool] | None`
  - Method L642: `_manifest_completed_row_count(self, *, store_root: Path, channel: str, market_slug: str, token_index: int, outcome: str | None, date: str) -> int | None`
  - Method L680: `_manifest_empty_day_exists(self, *, store_root: Path, channel: str, market_slug: str, token_index: int, outcome: str | None, date: str) -> bool`
  - Method L716: `_load_blob_range(self, *, store_root: Path, channel: str, market_slug: str, token_index: int, outcome: str | None, start: pd.Timestamp, end: pd.Timestamp) -> pd.DataFrame | None`
  - Method L921: `_cached_ts_ns_for_frame(self, frame: pd.DataFrame, column_name: str) -> np.ndarray | None`
  - Method L940: `_local_consolidated_candidates(cls, *, root: Path, channel: str, market_slug: str, token_index: int, outcome: str | None) -> tuple[Path, ...]`
  - Method L958: `_local_daily_candidates(cls, *, root: Path, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None) -> tuple[Path, ...]`
  - Method L977: `_local_consolidated_path(self, *, root: Path, channel: str, market_slug: str, token_index: int, outcome: str | None) -> Path | None`
  - Method L997: `_local_path_for_day(self, *, root: Path, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None) -> Path | None`
  - Method L1020: `_safe_read_parquet(path: Path) -> pd.DataFrame | None`
  - Method L1030: `_load_local_range(self, *, root: Path, channel: str, market_slug: str, token_index: int, outcome: str | None) -> pd.DataFrame | None`
  - Method L1050: `_load_local_day(self, *, root: Path, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None) -> pd.DataFrame | None`
  - Method L1073: `_api_url(*, base_url: str, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None) -> str`
  - Method L1092: `_api_cache_path(cls, *, base_url: str, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None) -> Path | None`
  - Method L1116: `_load_api_cache_day(self, *, base_url: str, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None) -> pd.DataFrame | None`
  - Method L1145: `_write_api_cache_day(self, *, payload: bytes, base_url: str, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None) -> None`
  - Method L1182: `_fast_api_cache_path(cls, *, base_url: str, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None) -> Path | None`
  - Method L1204: `_load_fast_cache_day(self, *, base_url: str, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None) -> pd.DataFrame | None`
  - Method L1233: `_write_fast_cache_day(self, *, frame: pd.DataFrame, base_url: str, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None) -> None`
  - Method L1306: `_load_api_day_cached(self, *, base_url: str, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None) -> tuple[pd.DataFrame | None, str]`
  - Method L1381: `_deltas_cache_path(cls, *, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None, instrument_id: object, start: pd.Timestamp, end: pd.Timestamp) -> Path | None`
  - Method L1410: `_load_deltas_cache_day(self, *, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None, start: pd.Timestamp, end: pd.Timestamp) -> tuple[list[OrderBookDeltas] | None, str]`
  - Method L1451: `_write_deltas_cache_day(self, *, records: Sequence[OrderBookDeltas], channel: str, date: str, market_slug: str, token_index: int, outcome: str | None, start: pd.Timestamp, end: pd.Timestamp) -> None`
  - Method L1495: `_trade_ticks_cache_path(cls, *, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None, instrument_id: object, start: pd.Timestamp, end: pd.Timestamp) -> Path | None`
  - Method L1524: `_load_trade_ticks_cache_day(self, *, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None, start: pd.Timestamp, end: pd.Timestamp) -> tuple[tuple[TradeTick, ...] | None, str]`
  - Method L1574: `_write_trade_ticks_cache_day(self, *, records: Sequence[TradeTick], channel: str, date: str, market_slug: str, token_index: int, outcome: str | None, start: pd.Timestamp, end: pd.Timestamp) -> None`
  - Method L1620: `_trade_ticks_to_cache_table(records: Sequence[TradeTick]) -> pa.Table`
  - Method L1647: `_trade_ticks_from_cache_table(self, table: pa.Table) -> tuple[TradeTick, ...]`
  - Method L1650: `_trade_ticks_from_cache_frame(self, frame: pd.DataFrame) -> tuple[TradeTick, ...]`
  - Method L1686: `_deltas_records_to_table(records: Sequence[OrderBookDeltas]) -> pa.Table`
  - Method L1721: `_deltas_records_from_columns(self, data: dict[str, list[object]]) -> list[OrderBookDeltas]`
  - Method L1771: `_resolve_presigned_url(*, url: str, api_key: str) -> str`
  - Method L1798: `_load_api_day(self, *, base_url: str, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None, api_key: str | None = None) -> pd.DataFrame | None`
  - Method L1890: `_column_to_ns(column: pd.Series, column_name: str) -> np.ndarray`
  - Method L1902: `_normalize_to_utc(value: pd.Timestamp) -> pd.Timestamp`
  - Method L1907: `_day_window(self, date: str, *, start: pd.Timestamp, end: pd.Timestamp) -> tuple[pd.Timestamp, pd.Timestamp] | None`
  - Method L1921: `_first_present_column(frame: pd.DataFrame, names: Sequence[str], *, label: str) -> str`
  - Method L1928: `_book_levels_from_value(value: object, *, side: str) -> tuple[PolymarketBookLevel, ...]`
  - Method L1963: `_book_levels_from_arrays(*, prices: object, sizes: object, side: str) -> tuple[PolymarketBookLevel, ...]`
  - Method L1980: `_book_side_map(levels: Sequence[PolymarketBookLevel]) -> dict[str, str]`
  - Method L1983: `_snapshot_to_deltas(self, *, bids: Sequence[PolymarketBookLevel], asks: Sequence[PolymarketBookLevel], ts_event: int) -> OrderBookDeltas | None`
  - Method L1999: `_diff_to_deltas(self, *, previous_bids: dict[str, str], previous_asks: dict[str, str], current_bids: dict[str, str], current_asks: dict[str, str], ts_event: int) -> OrderBookDeltas | None`
  - Method L2051: `_book_events_from_frame(self, frame: pd.DataFrame, *, start: pd.Timestamp, end: pd.Timestamp, include_order_book: bool = True) -> list[OrderBookDeltas]`
  - Method L2202: `_optional_column(frame: pd.DataFrame, names: Sequence[str]) -> str | None`
  - Method L2209: `_aggressor_side_from_value(value: object) -> AggressorSide`
  - Method L2217: `_onchain_fill_trade_ticks_from_frame(self, frame: pd.DataFrame, *, start: pd.Timestamp, end: pd.Timestamp) -> list[TradeTick]`
  - Method L2352: `_trade_ticks_from_native_columns(self, data: tuple[list[float], list[float], list[int], list[str], list[int], list[int]]) -> list[TradeTick]`
  - Method L2381: `_rounded_float64_array(values: object, precision: int) -> np.ndarray`
  - Method L2384: `_empty_local_blob_day_frame(self, *, entry: TelonexSourceEntry, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None) -> pd.DataFrame | None`
  - Method L2420: `_parse_telonex_trade_frame(self, frame: pd.DataFrame, *, channel: str, source: str, start: pd.Timestamp, end: pd.Timestamp, market_slug: str, token_index: int) -> tuple[TradeTick, ...] | None`
  - Method L2445: `load_telonex_onchain_fill_ticks(self, start: pd.Timestamp, end: pd.Timestamp, *, market_slug: str | None = None, token_index: int | None = None, outcome: str | None = None) -> tuple[TradeTick, ...] | None`
  - Method L2609: `_try_load_range_from_local(self, *, entry: TelonexSourceEntry, channel: str, market_slug: str, token_index: int, outcome: str | None, start: pd.Timestamp, end: pd.Timestamp) -> pd.DataFrame | None`
  - Method L2657: `_try_load_day_from_local(self, *, entry: TelonexSourceEntry, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None, start: pd.Timestamp, end: pd.Timestamp, range_cache: dict[Path, pd.DataFrame | None]) -> pd.DataFrame | None`
  - Method L2724: `_try_load_day_from_entry(self, *, entry: TelonexSourceEntry, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None) -> pd.DataFrame | None`
  - Method L2764: `_try_load_day_from_api_entry(self, *, entry: TelonexSourceEntry, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None) -> tuple[pd.DataFrame | None, str]`
  - Method L2806: `_telonex_api_source_label(self, *, base_url: str, channel: str, date: str, market_slug: str, token_index: int, outcome: str | None) -> str`
  - Method L2825: `_load_order_book_deltas_day(self, *, date: str, config: TelonexLoaderConfig, api_entries: Sequence[TelonexSourceEntry], start: pd.Timestamp, end: pd.Timestamp, market_slug: str, token_index: int, outcome: str | None, include_order_book: bool, range_cache: dict[Path, pd.DataFrame | None]) -> _TelonexDayResult`
  - Method L2925: `_iter_loaded_telonex_days(self, *, dates: list[str], config: TelonexLoaderConfig, api_entries: Sequence[TelonexSourceEntry], start: pd.Timestamp, end: pd.Timestamp, market_slug: str, token_index: int, outcome: str | None, include_order_book: bool) -> Iterator[_TelonexDayResult]`
  - Method L2991: `load_order_book_deltas(self, start: pd.Timestamp, end: pd.Timestamp, *, market_slug: str, token_index: int, outcome: str | None, include_order_book: bool = True) -> list[OrderBookDeltas]`
...
- Function L27: `_configure_native(enabled: bool) -> Any`
- Function L33: `_load_extension_from_path(path: Path) -> Any`
- Function L49: `_configure_native_extension(enabled: bool, extension_path: Path | None) -> Any`
- Function L66: `_time_call(fn: Callable[[], object], repeats: int) -> list[float]`
- Function L75: `_payloads(items: int) -> list[tuple[str, str]]`
- Function L106: `_telonex_inputs(items: int) -> list[tuple[str, str, str, int, str | None]]`
- Function L121: `_merge_inputs(items: int) -> tuple[list[int], list[int], list[int], list[int]]`
- Function L131: `_make_telonex_loader() -> RunnerPolymarketTelonexBookDataLoader`
- Function L153: `_make_pmxt_loader() -> PolymarketPMXTDataLoader`
- Function L173: `_telonex_flat_frame(items: int) -> pd.DataFrame`
- Function L195: `_telonex_trade_frame(items: int) -> pd.DataFrame`
- Function L208: `_bench_native_mode(*, enabled: bool, items: int, telonex_events: int, repeats: int, pmxt_rows: list[tuple[str, str]], telonex_rows: list[tuple[str, str, str, int, str | None]], merge_inputs: tuple[list[int], list[int], list[int], list[int]], telonex_frame: pd.DataFrame, telonex_trade_frame: pd.DataFrame, native_extension_path: Path | None) -> dict[str, float | bool]`
- Function L434: `main() -> None`
